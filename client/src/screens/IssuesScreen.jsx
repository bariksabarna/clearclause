  ...
  return (
    <>
      <DisclaimerBar
        ...
        signal="Diagnostics Engine v4.1 Active"
      />
            ...
            <div className="space-y-6 lg:col-span-8">
              ...
              <div className="flex flex-col items-center justify-between gap-4 bg-surface-container-low p-4 font-label-sm text-label-sm text-secondary md:flex-row">
                <div className="flex items-center gap-3">
                  ...
                  <span>
                    All uploaded files are purged immediately from temporary scratch storage
                    following a failure.
                  </span>
                </div>
                <button
            ...
            <aside className="space-y-4 lg:col-span-4">
              ...
              <div className="bg-surface-container-high p-6">
                ...
                <p className="mb-4 font-body-sm text-body-sm text-on-surface-variant">
                  Need urgent assistance with an encrypted redline or sealed court filing that
                  failed validation?
                </p>
                <Link
                  to="/"
